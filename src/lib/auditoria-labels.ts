...
export const ETIQUETAS_ACCION: Record<string, string> = {
  ...
  "poliza.eliminar": "🗑️ Póliza de seguro eliminada",
  "siniestro.crear": "⚠️ Siniestro registrado",
  "siniestro.actualizar": "📝 Siniestro actualizado",
  "siniestro.eliminar": "🗑️ Siniestro eliminado",
